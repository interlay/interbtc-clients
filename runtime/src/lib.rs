...
=======
    ...
    OraclePallet, RedeemPallet, RefundPallet, RelayPallet, ReplacePallet, SecurityPallet, TimestampPallet, UtilFuncs,
    VaultRegistryPallet, SS58_PREFIX,
>>>>>>> 4221bbca (test: add missing trait items to mocks)
};
