...
pub struct AccountStore<T: Wrapped> {
...
pub struct ReservedEvent<T: Wrapped> {
    pub account_id: T::AccountId,
    pub balance: T::Balance,
}

#[derive(Clone, Debug, PartialEq, Call, Encode)]
pub struct TransferCall<'a, T: Wrapped> {
...
#[derive(Clone, Debug, Eq, PartialEq, Event, Decode)]
pub struct TransferEvent<T: Wrapped> {
